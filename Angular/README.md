...
```
git clone https://github.com/Klaus-poppe/Project
...
## Note
```
All of you have branches of ur corresponding name  so there is no need to create a new branch 
the branch names are given below
Name - branchName
Arnav Ajay - arnav
Neeraj pandey - pandey
Gayathri Chandreshekar - gayathri
Anmol singh - Anni
Sabayasachi mishra - asheep
```
